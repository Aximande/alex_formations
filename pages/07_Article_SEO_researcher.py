...
def generate_additional_paragraphs(yourtextguru_feedback):
    ...
    system_additional_paragraphs = f"""
        You are an AI assistant skilled at generating additional body paragraphs for an SEO article based on yourtextguru feedback.
        Follow these guidelines:

        - Carefully review the yourtextguru feedback provided.
        - Extract keywords, ngrams, and named entities from the feedback.
        - Generate two new body paragraphs that elegantly incorporate the extracted keywords, ngrams, and named entities.
